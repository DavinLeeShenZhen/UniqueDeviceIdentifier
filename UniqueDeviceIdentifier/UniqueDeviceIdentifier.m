...
@implementation UniqueDeviceIdentifier
...
+ (NSString *)uid {
    return [[[UniqueDeviceIdentifier alloc] initWithKey:@"UniqueDeviceIdentifier"] uid];
}
 ...
 */
- (void)save {
    if (![UniqueDeviceIdentifier valueForUserDefaultsKey:_uidKey]) {
        [UniqueDeviceIdentifier setValue:_uid forUserDefaultsKey:_uidKey];
    }
    if (![UniqueDeviceIdentifier valueForKeychainKey:_uidKey service:_uidKey]) {
        [UniqueDeviceIdentifier setValue:_uid forKeychainKey:_uidKey inService:_uidKey];
    }
}
